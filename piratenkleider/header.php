		...
		<div id="masthead">
			<div id="sub">
				...
				<!-- #search form -->
					...
					<div>
						<input type="text" size="12" name="s" id="s" value="Suchbegriff" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;"/>
